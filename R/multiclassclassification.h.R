...
MulticlassClassificationOptions <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "MulticlassClassificationOptions",
...
MulticlassClassificationResults <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "MulticlassClassificationResults",
    ...
    active = list(
        ...
        text_sen = function() private$.items[["text_sen"]],
        plots_pfi = function() private$.items[["plots_pfi"]],
        plots_shap = function() private$.items[["plots_shap"]],
        plots_olden = function() private$.items[["plots_olden"]],
        text_tables = function() private$.items[["text_tables"]],
        ...
        pairwise_hstat_norm = function() private$.items[["pairwise_hstat_norm"]],
        pairwise_hstat_raw = function() private$.items[["pairwise_hstat_raw"]],
    ...
    public=list(
        initialize=function(options) {
            ...
            self$add(jmvcore::Preformatted$new(
                ...
                visible="(pfi || shap_mean || shap_dir || shap_box || shap_swarm || olden)"))
            self$add(jmvcore::Image$new(
                options=options,
                name="plots_pfi",
                title="Permutation Feature Importance Plots",
                width=600,
                height=600,
                renderFun=".plot_pfi",
                visible="(pfi)",
            ...
            self$add(jmvcore::Array$new(
                options=options,
                name="plots_shap",
                title="SHAP (Shapley Additive exPlanations) Plots",
                template=jmvcore::Image$new(
                    options=options,
                    title="$key",
                    width=600,
            ...
            self$add(jmvcore::Image$new(
                options=options,
                name="plots_olden",
                title="Olden's Method Sensitivity Plots",
                width=600,
                height=600,
                renderFun=".plot_olden",
                visible="(olden)",
                clearWith=list(
                    "seed",
                    "dep",
            ...
            self$add(jmvcore::Array$new(
                options=options,
                name="table_pfi",
                title="Permutation Feature Importance Tables",
            ...
            self$add(jmvcore::Array$new(
                options=options,
                name="table_shap",
                title="Shapley Additive exPlanations (SHAP) Tables",
                template=jmvcore::Table$new(
                    options=options,
                    title="$key",
                    clearWith=list(
            ...
            self$add(jmvcore::Array$new(
                options=options,
                name="table_olden",
                title="Olden's Method Sensitivity Tables",
                template=jmvcore::Table$new(
                    options=options,
                    title="$key",
                    clearWith=list(
            ...
            self$add(jmvcore::Table$new(
                ...
                title="Pairwise H-statistic Normalized",
                visible="(h2_pair_norm)",
                columns=list(
                    list(
                        `name`="Pairwise Interaction", 
            ...
            self$add(jmvcore::Table$new(
                ...
                title="Pairwise H-statistic Raw",
                visible="(h2_pair_raw)",
                columns=list(
                    list(
                        `name`="Pairwise Interaction", 
            ...
            self$add(jmvcore::Output$new(
                ...
                varDescription="Predicted Class from Multiclass Classification",
                measureType="nominal",
                clearWith=list(
                    "seed",
                    "dep",
            ...
            self$add(jmvcore::Output$new(
                ...
                varTitle="Predicted Probabilities",
                varDescription="Predicted Probabilities from Multiclass Classification",
...
MulticlassClassificationBase <- if (requireNamespace("jmvcore", quietly=TRUE)) R6::R6Class(
    "MulticlassClassificationBase",
    ...
    public = list(
        initialize = function(options, data=NULL, datasetId="", analysisId="", revision=0) {
            super$initialize(
                ...
                version = c(1,0,0),
                options = options,
                results = MulticlassClassificationResults$new(options=options),
                data = data,
                datasetId = datasetId,
...
#'   \code{results$text_sen} \tab \tab \tab \tab \tab a preformatted \cr
#'   \code{results$plots_pfi} \tab \tab \tab \tab \tab an array of plots \cr
#'   \code{results$plots_shap} \tab \tab \tab \tab \tab an array of plots \cr
#'   \code{results$plots_olden} \tab \tab \tab \tab \tab olden barplot \cr
#'   \code{results$text_tables} \tab \tab \tab \tab \tab a preformatted \cr
#'   \code{results$table_pfi} \tab \tab \tab \tab \tab an array of tables \cr
#'   \code{results$table_shap} \tab \tab \tab \tab \tab an array of tables \cr
#'   \code{results$table_olden} \tab \tab \tab \tab \tab an array of tables \cr
...
#'   \code{results$pairwise_hstat_norm} \tab \tab \tab \tab \tab a table \cr
#'   \code{results$pairwise_hstat_raw} \tab \tab \tab \tab \tab a table \cr
...
MulticlassClassification <- function(
    ...
    options <- MulticlassClassificationOptions$new(
        run = run,
        seed = seed,
        dep = dep,
        covs = covs,
